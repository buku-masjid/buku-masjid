...
class SpendingToPartnerGraph extends Component
{
    public $spendingToPartnerSeries;
    public $partnerTypeCode;
    public $isLoading = true;

    public function render()
    {
        return view('livewire.partners.spending_to_partner_graph');
    }

    public function getSpendingToPartnerSeries()
    {
        $this->spendingToPartnerSeries = $this->calculateSpendingToPartnerSeries();
        $this->isLoading = false;
    }

    private function calculateSpendingToPartnerSeries()
    {
        $cacheKey = 'calculatePartnerSpendingToPartnerSeries_'.$this->partnerTypeCode;
        ...
        $partnerMonthlySummary = $this->calculatePartnerMonthlySummary($this->partnerTypeCode, 0);
