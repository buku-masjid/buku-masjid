...
return [
    ...
    'actions' => 'Pilihan',
    'empty' => 'Belum ada file backup database.',
    ...
    'sure_to_restore' => 'Anda yakin akan mengembalikan database dengan file backup "<strong>:filename</strong>"? <br><br>Harap dipastikan <strong>database saat ini sudah dibackup</strong>.',
    'cancel_restore' => 'Batal Restore',
    'confirm_restore' => 'Ya, Restore database!',
    'restore_confirm' => 'Klik OK untuk me-Restore.',
    'restored' => 'Database sudah di-restore dengan file backup :filename',
