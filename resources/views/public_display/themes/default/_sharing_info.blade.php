...
<div class="swiper myVerticalSwiper jm-card-sharing overflow-hidden h-[300px] lg:h-1/2">
    <div class="swiper-wrapper">
        @foreach($quotes as $quote)
            <div class="swiper-slide flex items-center overflow-hidden">
                <div class="p-[30px]  lg:p-5 2xl:p-8 text-center text-[1.4vw] leading-none 2xl:leading-[1.6vw] align-middle">
                    "{{ $quote['quote'] }}"
