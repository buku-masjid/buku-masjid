@extends('public_display.themes.default.layout')
...
@section('content')
    ...
    <div class="jm-section jm-main-content">
        <div class="jm-left-column col-6 split py-4 pe-4">
            @include('public_display.themes.default._date_time')
            @include('public_display.themes.default._sharing_info')
        </div>
        <div class="jm-right-column col-6 py-4">
            @include('public_display.themes.default._carousel')
        </div>
    </div>
