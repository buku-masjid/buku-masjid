...
@section('content')
    <div class="lg:flex md:h-[15vh] 2xl:h-[10vh] items-center">
        <div class="md:w-1/3 lg:w-1/4 lg:h-full mb-2 lg:mb-0 items-center justify-content-start jm-card-masjid-info text-start">
    ...
    <div class="lg:flex pt-0 md:h-[20vh] 2xl:h-[20vh] w-full space-x-3">
