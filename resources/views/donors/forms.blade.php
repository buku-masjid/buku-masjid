        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    {{ link_to_route('donors.index', '', ['type_code' => $selectedTypeCode], ['class' => 'close']) }}
                </div>
                ...
                <div class="modal-footer">
                    ...
                    {{ link_to_route('donors.index', __('app.cancel'), ['type_code' => $selectedTypeCode], ['class' => 'btn btn-secondary']) }}
                </div>
                {{ Form::close() }}
            </div>
        </div>
    ...
    <div id="partnerModal" class="modal" role="dialog">
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                {!! Form::model($editablePartner, ['route' => ['donors.update', $editablePartner], 'method' => 'patch']) !!}
                <div class="modal-body">
                    {!! FormField::text('name', ['required' => true, 'label' => __('partner.name')]) !!}
                    <div class="row">
                        <div class="col-md-6">
    ...
    <div id="partnerModal" class="modal" role="dialog">
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    {!! FormField::delete(
                        ['route' => ['donors.destroy', $editablePartner], 'class' => ''],
