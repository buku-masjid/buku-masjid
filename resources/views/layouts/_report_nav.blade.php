...
<div class="list-group list-group-transparent mb-0 text-uppercase">
    <a href="{{ route('dashboard.index', Request::all()) }}" style="padding-right: 4px;" class="list-group-item list-group-item-action d-flex align-items-center {{ Request::segment(1) == 'dashboard' ? 'active' : '' }}">
        <span class="icon mr-2"><i class="fe fe-database"></i></span>{{ __('dashboard.dashboard') }}
    </a>
    <a href="{{ route('reports.finance.summary', Request::all()) }}" style="padding-right: 4px;" class="list-group-item list-group-item-action d-flex align-items-center {{ in_array(Request::segment(3), ['summary']) ? 'active' : '' }}">
