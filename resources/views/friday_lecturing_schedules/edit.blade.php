...
<div class="row justify-content-center">
    <div class="col-md-6">
        ...
        @can('delete', $lecturingSchedule)
            <div class="card">
                <div class="card-header">{{ __('lecturing_schedule.delete_for_friday') }}</div>
                <div class="card-body">
                ...
                <hr style="margin:0">
                <div class="card-body text-danger">{{ __('lecturing_schedule.delete_confirm_for_friday') }}</div>
        ...
        <div class="card">
            <div class="card-header">
                ...
                {{ __('lecturing_schedule.edit_for_friday') }}
            </div>
            {{ Form::model($lecturingSchedule, ['route' => ['friday_lecturing_schedules.update', $lecturingSchedule], 'method' => 'patch']) }}
            <div class="card-body">
                <div class="row">
                    <div class="col-md-6">
                        {!! FormField::text('date', [
                    ...
                    <div class="col-md-6">
                        <div class="row">
                            <div class="col-6">{!! FormField::text('start_time', ['required' => true, 'label' => __('lecturing_schedule.time'), 'placeholder' => '12:15']) !!}</div>
                        </div>
