...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-lg-6">
            @livewire('public-home.daily-lecturings', ['date' => today()->addWeek(), 'dayTitle' => 'today'])
            @livewire('public-home.daily-lecturings', ['date' => today()->addWeek()->addDay(), 'dayTitle' => 'tomorrow'])
        </div>
    </div>
@endsection
