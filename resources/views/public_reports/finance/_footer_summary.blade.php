<div class="fs-3 fw-bold text-center text-sm-end border-top pt-3 px-lg-4">
    ...
    <h1 class="bm-txt-dark fw-bolder">{{ format_number($lastMonthBalance) }}</h1>
</div>
<div class="row fs-3 py-3 px-lg-4 py-lg-3">
    <div class="col text-center text-sm-start fs-2 fw-bold py-3">
    ...
    <div class="col-sm-auto text-center pt-3 pt-sm-0  text-sm-end">
        ...
        <h2 class="bm-txt-dark ">{{ format_number($currentMonthBalance) }}</h2>
    </div>
</div>
<div class="fs-3 fw-bold text-center text-sm-end border-top pt-3 px-lg-4">
    {{ __('transaction.end_balance') }}
    <h1 class="bm-txt-netral fw-bolder">{{ format_number($lastMonthBalance + $currentMonthBalance) }}</h1>
</div>
