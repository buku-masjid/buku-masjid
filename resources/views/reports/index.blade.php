...
<div class="page-header mt-0">
    ...
    <div class="page-options d-flex">
        ...
        <div class="form-group">
            {{ link_to_route('reports.index', __('report.prev_month'), ['month' => $prevMonthDate->format('m'), 'year' => $prevMonthDate->format('Y')], ['class' => 'btn btn-secondary mr-1']) }}
            {{ link_to_route('reports.index', __('report.next_month'), ['month' => $nextMonthDate->format('m'), 'year' => $nextMonthDate->format('Y')], ['class' => 'btn btn-secondary']) }}
        </div>
        {{ Form::close() }}
    </div>
</div>
